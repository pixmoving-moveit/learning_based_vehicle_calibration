...
class NeuralNetworkSteering2(Node):
    class NeuralNetwork(nn.Module):
        def __init__(self):
            super(NeuralNetworkSteering2.NeuralNetwork, self).__init__()
    ...
    def __init__(self):
        super().__init__('neural_network_steering2')

        self.model = self.NeuralNetwork()

        
        data = pd.read_csv('steering_02.csv')
        dataa = pd.read_csv('steering_02.csv')
        ...
        ax.set_title('Neural Network Output vs. Velocity and Throttling | Steering 2')
...
def main():
    rclpy.init()
    neural_network_steering2 = NeuralNetworkSteering2()
