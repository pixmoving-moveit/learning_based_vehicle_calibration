...
# Read the data
columns = ["Velocity", "Throttling", "Steering", "Acceleration_with_pitch_comp"]
df = pd.read_csv("throttling_steer.csv", usecols=columns)
...
scatter = ax.scatter3D(xdata, ydata, zdata, c=kdata, cmap=cmap, marker='o')
