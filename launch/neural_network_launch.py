...
def generate_launch_description():
    return launch.LaunchDescription([
        ...
        launch_ros.actions.Node(
            ...
            output='screen',
            parameters=[
                {'filter_vel_brake': launch.substitutions.LaunchConfiguration('filter_vel_brake')},
                {'filter_cmd_brake': launch.substitutions.LaunchConfiguration('filter_cmd_brake')},
                {'filter_acc_brake': launch.substitutions.LaunchConfiguration('filter_acc_brake')},
            ],
        ),
    ])
